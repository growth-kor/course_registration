export const CATEGORIES = {
  ...
  self_study: { id: 'self_study', label: '자습 / 공부', icon: '📖', defaultColor: '#ffe600' },
  routine: { id: 'routine', label: '루틴 / 운동', icon: '🏋️', defaultColor: '#7ef6d6' },
  other: { id: 'other', label: '기타 / 휴식', icon: '☕', defaultColor: '#d8b4fe' }
};
